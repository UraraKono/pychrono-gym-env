# pychrono/demos/vehicle/demo_VEH_HMMWV_circle.py
...
my_hmmwv.SetInitPosition(chrono.ChCoordsysD(chrono.ChVectorD(-75, 0, 0.5),chrono.QUNIT)) #ChCoordsysD: position and rotation class
my_hmmwv.SetPowertrainType(veh.PowertrainModelType_SHAFTS)
my_hmmwv.SetDriveType(veh.DrivelineTypeWV_RWD) #RWD: rear wheel drive. You can choose between RWD, FWD, AWD for HMMWV
